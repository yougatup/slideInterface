...
sbt "run-main org.allenai.pdffigures2.FigureExtractorBatchCli ../paperData/$1/paper.pdf -s stat_file.json -m imageOutput"
sbt "run-main org.allenai.pdffigures2.FigureExtractorBatchCli ../paperData/$1/paper.pdf -s stat_file.json -d dataOutput"
sbt "run-main org.allenai.pdffigures2.FigureExtractorBatchCli ../paperData/$1/paper.pdf -s stat_file.json -g structure"

cp imageOutput* ../paperData/$1/
cp dataOutput* ../paperData/$1/
cp structure* ../paperData/$1/
